    ...
    public void turnoGame(){
        do {
            ...
            if (jg1 == 1 && jg2 == 1) {
                ...
                System.out.println("Jogador 2 tentou defender, mas tomou hit!");
                j1.defesa(0);
                j2.defesa(j1.ataque());
                ...
                System.out.println("Jogador 2 tentou defender especial, mas tomou hit!");
                j1.defesa(2);
                j2.defesa(j1.ataque()); // colocar especial

            }
            else  {
                System.out.println("Jogador 1 tentou defender, mas tomou hit!");
                j1.defesa(j2.ataque());
                j2.defesa(0);
                System.out.println("HP do Jogador 2: " + j2.vida());
            }

            // Exibe o HP atual de cada Pokémon
            System.out.println("HP do Jogador 1: " + j1.vida());
           ;
            if (j1.vida() <=0 ) {
